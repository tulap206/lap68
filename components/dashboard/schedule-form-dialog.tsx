...
function scheduleToForm(editing: Schedule | null): ScheduleFormValues {
  ...
  return {
    ...
    amount:
      editing.amount != null ? formatMoneyInput(String(editing.amount)) : "",
    ...
    endDate: editing.recurrence?.end_date
      ? toDateInputValue(editing.recurrence.end_date)
      : "",
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <DialogHeader>
          <DialogTitle>
            {editing ? "Sửa lịch thu/chi" : "Thêm lịch thu/chi"}
          </DialogTitle>
          <DialogDescription>
            Nhắc hẹn đóng tiền hoặc thu tiền theo thời gian
          </DialogDescription>
        </DialogHeader>
        <div className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(v) =>
                  setForm({
                    ...form,
                    direction: v as ScheduleDirection,
                    categoryId: "",
                  })
                }
              >
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(v) =>
                  setForm({ ...form, scheduleKind: v as ScheduleKind })
                }
              >
                <SelectTrigger>
                  <SelectValue />
          ...
          {form.scheduleKind === "recurring" && (
            <div className="grid grid-cols-3 gap-2 rounded-xl border border-border p-3 bg-muted/40">
