      ...
      <div className={panelBodyClass}>
        <div className="flex-1 flex items-center justify-center rounded-lg border border-dashed border-border min-h-[200px]">
          <div className="text-center px-4">
            <History className="h-6 w-6 text-muted-foreground/70 mx-auto mb-1.5" />
      ...
      <div className="flex-1 min-h-0 overflow-y-auto">
        <ModuleResponsiveTable
          ...
          rows={pageLogs.map((l) => [
            ...
            <span key="a" className="font-medium text-foreground/90 text-sm">
              {l.action}
            </span>,
            <span
              key="d"
              className="text-muted-foreground text-sm truncate block max-w-[140px] lg:max-w-[200px] xl:max-w-none"
            >
              {l.details || "—"}
            </span>,
          ])}
