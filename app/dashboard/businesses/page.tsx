...
export default function BusinessesPage() {
  ...
  return (
    <ModulePageShell module="cashflow">
      <ModuleSubpageHeader
        module="cashflow"
        title="Quản lý việc kinh doanh"
        subtitle="Tạo và sắp xếp các mảng thu chi"
        actions={
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>
              {editing ? "Sửa việc" : "Thêm việc kinh doanh"}
            </DialogTitle>
          </DialogHeader>
          <div className="space-y-4">
            ...
            <div className="flex gap-2">
              ...
              <AccentButton module="cashflow" className="flex-1" onClick={save}>
                Lưu
              </AccentButton>
            </div>
          </div>
