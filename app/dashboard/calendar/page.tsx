  ...
  return (
    <ModulePageShell module="cashflow">
      <ModuleSubpageHeader
        module="cashflow"
        title="Lịch thu/chi"
        subtitle="Xem lịch đến hạn theo tháng"
      />
          ...
          <ModuleSectionCard title=" ">
            <div className="p-3 sm:p-4">
              <div className="flex items-center justify-between mb-3 sm:mb-4 gap-2">
                ...
                <h3 className="font-bold text-foreground text-sm sm:text-base text-center">
                  Tháng {month + 1}/{year}
                </h3>
                <Button
                  variant="ghost"
              ...
              {loading ? (
                <div className="h-56 sm:h-64 animate-pulse bg-muted/50 rounded-xl" />
              ) : (
                <>
                  <div className="grid grid-cols-7 gap-0.5 sm:gap-1 mb-1">
                    {WEEKDAYS.map((w) => (
                      <div
                        key={w}
                        className="text-center text-[10px] sm:text-xs text-muted-foreground py-1"
                      >
                        {w}
                      </div>
                    ))}
                      ...
                      return (
                        <button
                          ...
                          className={cn(
                            ...
                            isSelected
                              ? "border-green-500/50 bg-[var(--pale-green)]"
                        ...
                        >
                          <span
                            className={cn(
                              ...
                              isToday ? "text-income" : "text-foreground/80",
                            )}
                          >
                            {day}
                          </span>
                          {count > 0 && (
                            <span className="text-[9px] sm:text-[10px] text-amber-400 leading-none">
                              {count}
                            </span>
                          )}
                        </button>
                ...
                return (
                  ...
                  >
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      {biz?.name} ·{" "}
                      {s.direction === "collect" ? "Phải thu" : "Phải chi"}
